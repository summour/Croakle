              ...
              >
                ...
                <div className="pt-1.5 space-y-1.5 border-t border-[#1D1B18]/15 dark:border-[#F8F7F4]/15">
                  ...
                  <div className="flex items-center justify-between text-[9px] text-[#1D1B18]/50 dark:text-[#F8F7F4]/50 pt-0.5">
                    <span>Lifetime: <strong className="text-[#1D1B18] dark:text-[#F8F7F4]">{stat.lifetime}</strong></span>
                    <span>Month rate: <strong className="text-[#1D1B18] dark:text-[#F8F7F4]">{stat.actualMonthRate}%</strong></span>
                  </div>
                </div>
              </div>
            );
