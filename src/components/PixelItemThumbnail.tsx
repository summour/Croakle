...
export const PixelItemThumbnail: React.FC<PixelItemThumbnailProps> = ({
  ...
  switch (key) {
    ...
    // -----------------------------------------------------------
    // F. HABITATS & SCENES (Mini 16-Bit / 32-Bit Pixel Art Dioramas)
    // -----------------------------------------------------------
    case 'retro_arcade':
    case 'arcade':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Cyber Dark Room */}
          <rect x="2" y="2" width="20" height="20" fill="#09090B" />
          <rect x="2" y="10" width="20" height="1" fill="#EC4899" opacity="0.5" />
          <rect x="2" y="15" width="20" height="1" fill="#06B6D4" opacity="0.6" />
          {/* Arcade Cabinet */}
          <rect x="3" y="4" width="7" height="16" fill="#1E1B4B" />
          <rect x="4" y="5" width="5" height="2" fill="#EC4899" />
          <rect x="4" y="8" width="5" height="5" fill="#064E3B" />
          <rect x="5" y="9" width="3" height="3" fill="#34D399" />
          <rect x="4" y="14" width="5" height="2" fill="#312E81" />
          <rect x="5" y="14" width="1" height="1" fill="#EF4444" />
          {/* Claw Machine */}
          <rect x="14" y="4" width="7" height="16" fill="#18181B" />
          <rect x="14" y="4" width="7" height="1" fill="#FACC15" />
          <rect x="15" y="5" width="5" height="2" fill="#EAB308" />
          <rect x="15" y="8" width="5" height="5" fill="#38BDF8" opacity="0.3" />
          <rect x="16" y="9" width="1" height="2" fill="#CBD5E1" />
          <rect x="17" y="11" width="2" height="2" fill="#EC4899" />
          {/* DDR Dance Floor Pad */}
          <rect x="2" y="19" width="20" height="3" fill="#1E1B4B" />
          <rect x="4" y="19" width="4" height="2" fill="#F43F5E" />
          <rect x="16" y="19" width="4" height="2" fill="#06B6D4" />
        </svg>
      );
    ...
    case 'forest_camp':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Alpine Sky & Distant Mountain */}
          <rect x="2" y="2" width="20" height="20" fill="#0284C7" />
          {/* Jagged Mountain Peak */}
          <rect x="11" y="4" width="2" height="2" fill="#FFFFFF" />
          <rect x="9" y="6" width="6" height="2" fill="#FFFFFF" />
          <rect x="7" y="8" width="10" height="3" fill="#334155" />
          <rect x="5" y="11" width="14" height="4" fill="#1E293B" />
          {/* Festoon Light String Wire & Glowing Amber Bulbs */}
          <rect x="4" y="9" width="16" height="1" fill="#451A03" />
          <rect x="6" y="10" width="2" height="2" fill="#FEF08A" />
          <rect x="11" y="10" width="2" height="2" fill="#FEF08A" />
          <rect x="16" y="10" width="2" height="2" fill="#FEF08A" />
          {/* Flanking Pine Trees */}
          <rect x="3" y="6" width="3" height="3" fill="#10B981" />
          <rect x="2" y="9" width="5" height="4" fill="#059669" />
          <rect x="2" y="13" width="5" height="5" fill="#064E3B" />
          <rect x="18" y="6" width="3" height="3" fill="#10B981" />
          <rect x="17" y="9" width="5" height="4" fill="#059669" />
          <rect x="17" y="13" width="5" height="5" fill="#064E3B" />
          {/* Canvas A-Frame Tent on Left */}
          <rect x="6" y="12" width="2" height="2" fill="#0F766E" />
          <rect x="5" y="14" width="5" height="4" fill="#0D9488" />
          <rect x="4" y="17" width="7" height="2" fill="#14B8A6" />
          <rect x="6" y="14" width="3" height="4" fill="#FEF08A" /> {/* Glowing Tent Door */}
          {/* Basalt Ring Campfire on Right */}
          <rect x="14" y="16" width="4" height="2" fill="#334155" />
          <rect x="14" y="14" width="4" height="3" fill="#EA580C" />
          <rect x="15" y="13" width="2" height="2" fill="#FDE047" />
          {/* Tartan Mat / Wooden Camp Platform */}
          <rect x="9" y="17" width="6" height="2" fill="#DC2626" />
    ...
    case 'convenience_store':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          <rect x="2" y="2" width="20" height="20" fill="#F8FAFC" />
          {/* 7-Mart Stripe Header */}
          <rect x="2" y="2" width="20" height="2" fill="#EA580C" />
          <rect x="2" y="4" width="20" height="2" fill="#16A34A" />
          {/* Drink Fridge on Left */}
          <rect x="3" y="7" width="7" height="11" fill="#334155" />
          <rect x="4" y="8" width="5" height="9" fill="#0284C7" opacity="0.3" />
          <rect x="5" y="9" width="1" height="2" fill="#16A34A" />
          <rect x="7" y="9" width="1" height="2" fill="#DC2626" />
          <rect x="5" y="13" width="1" height="2" fill="#FACC15" />
          <rect x="7" y="13" width="1" height="2" fill="#EC4899" />
          {/* Oden / Bun Warmer on Right */}
          <rect x="14" y="8" width="7" height="10" fill="#475569" />
          <rect x="15" y="9" width="5" height="3" fill="#FFFFFF" />
          <rect x="15" y="13" width="5" height="4" fill="#B45309" />
          {/* Counter with Stepped Onigiri */}
          <rect x="11" y="14" width="2" height="1" fill="#FFFFFF" />
          <rect x="10" y="15" width="4" height="2" fill="#FFFFFF" />
          <rect x="9" y="17" width="6" height="1" fill="#FFFFFF" />
          <rect x="11" y="16" width="2" height="2" fill="#18181B" />
          {/* Tile Floor */}
    ...
    case 'red_riding_forest':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Sunset Rose Sky */}
          <rect x="2" y="2" width="20" height="20" fill="#9D174D" />
          {/* Ancient Trees */}
          <rect x="3" y="4" width="4" height="14" fill="#451A03" />
          <rect x="2" y="2" width="6" height="5" fill="#064E3B" />
          <rect x="17" y="4" width="4" height="14" fill="#451A03" />
          <rect x="16" y="2" width="6" height="5" fill="#064E3B" />
          {/* Giant Fairy Toadstool Platform */}
          <rect x="7" y="13" width="10" height="4" fill="#DC2626" />
          <rect x="8" y="12" width="8" height="2" fill="#EF4444" />
          <rect x="9" y="13" width="1" height="1" fill="#FFFFFF" />
          <rect x="14" y="13" width="1" height="1" fill="#FFFFFF" />
          {/* Little Red Wicker Basket */}
          <rect x="4" y="15" width="4" height="3" fill="#A16207" />
          <rect x="4" y="14" width="4" height="1" fill="#DC2626" />
          {/* Forest Floor */}
          <rect x="2" y="18" width="20" height="4" fill="#14532D" />
        </svg>
      );
    ...
    case 'sushi_bar':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Hinoki Wall & Indigo Noren */}
          <rect x="2" y="2" width="20" height="20" fill="#FEF3C7" />
          <rect x="3" y="2" width="5" height="5" fill="#1E3A8A" />
          <rect x="9" y="2" width="5" height="5" fill="#1E3A8A" />
          <rect x="15" y="2" width="5" height="5" fill="#1E3A8A" />
          {/* Glass Neta Case */}
          <rect x="14" y="8" width="7" height="5" fill="#38BDF8" opacity="0.3" />
          <rect x="14" y="8" width="7" height="1" fill="#94A3B8" />
          <rect x="15" y="10" width="2" height="2" fill="#BE123C" />
          <rect x="18" y="10" width="2" height="2" fill="#EA580C" />
          {/* Hinoki Wood Counter */}
          <rect x="2" y="13" width="20" height="9" fill="#D97706" />
          <rect x="2" y="13" width="20" height="2" fill="#FDE68A" />
          {/* Black Lacquered Sushi Board & Nigiri */}
          <rect x="7" y="15" width="10" height="3" fill="#18181B" />
          <rect x="8" y="14" width="3" height="2" fill="#DC2626" />
          <rect x="13" y="14" width="3" height="2" fill="#EA580C" />
        </svg>
      );
    ...
    case 'sauna_bathhouse':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          ...
          <rect x="2" y="2" width="20" height="20" fill="#78350F" />
          <rect x="2" y="5" width="20" height="1" fill="#451A03" />
          <rect x="2" y="9" width="20" height="1" fill="#451A03" />
          <rect x="2" y="13" width="20" height="1" fill="#451A03" />
          {/* Wall Light Sconce */}
          <rect x="4" y="5" width="3" height="4" fill="#FEF08A" />
          {/* Volcanic Stone Kiukaat Stove with Glowing Heat & Steam */}
          <rect x="15" y="5" width="6" height="8" fill="#27272A" />
          <rect x="16" y="4" width="4" height="2" fill="#52525B" />
          <rect x="17" y="6" width="2" height="1" fill="#EA580C" />
          <rect x="16" y="2" width="2" height="2" fill="#FFFFFF" opacity="0.6" />
          {/* Tiered Aspen Benches & Towel */}
          <rect x="2" y="13" width="20" height="9" fill="#D97706" />
          <rect x="2" y="13" width="20" height="2" fill="#FDE68A" />
          <rect x="7" y="14" width="10" height="3" fill="#FAFAF9" />
        </svg>
      );
    ...
    case 'zen_pond':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Twilight Sky & Distant Pagoda */}
          <rect x="2" y="2" width="20" height="20" fill="#0F172A" />
          <rect x="4" y="6" width="3" height="4" fill="#334155" />
          {/* Stone Lantern on Shore */}
          <rect x="16" y="6" width="4" height="6" fill="#475569" />
          <rect x="17" y="8" width="2" height="2" fill="#FEF08A" />
          {/* Deep Pond Waters */}
          <rect x="2" y="11" width="20" height="11" fill="#075985" />
          <rect x="2" y="15" width="20" height="7" fill="#0C4A6E" />
          {/* Giant Lilypad Island & Blooming Lotus */}
          <rect x="6" y="13" width="12" height="4" fill="#15803D" />
          <rect x="7" y="14" width="10" height="2" fill="#4ADE80" />
          <rect x="4" y="12" width="3" height="3" fill="#EC4899" />
          <rect x="5" y="13" width="1" height="1" fill="#FDE047" />
        </svg>
      );
    ...
    case 'treehouse':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Warm Oak Plank Walls */}
          <rect x="2" y="2" width="20" height="20" fill="#451A03" />
          <rect x="2" y="7" width="20" height="1" fill="#271003" />
          <rect x="2" y="13" width="20" height="1" fill="#271003" />
          {/* Bookshelf on Left */}
          <rect x="3" y="4" width="5" height="10" fill="#271003" />
          <rect x="4" y="5" width="1" height="3" fill="#DC2626" />
          <rect x="6" y="5" width="1" height="3" fill="#2563EB" />
          {/* Sunny Forest Window on Right */}
          <rect x="13" y="3" width="8" height="8" fill="#60A5FA" />
          <rect x="13" y="7" width="8" height="4" fill="#16A34A" />
          <rect x="13" y="3" width="1" height="8" fill="#DC2626" />
          <rect x="20" y="3" width="1" height="8" fill="#DC2626" />
          {/* Mandala Rug & Floorboards */}
          <rect x="2" y="14" width="20" height="8" fill="#522304" />
          <rect x="6" y="15" width="12" height="4" fill="#EA580C" />
          <rect x="8" y="16" width="8" height="2" fill="#0D9488" />
        </svg>
      );
    ...
    case 'sakura_shrine':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Sunrise Violet Sky */}
          <rect x="2" y="2" width="20" height="20" fill="#A21CAF" />
          {/* Stepped Snowcap Fuji */}
          <rect x="11" y="4" width="2" height="1" fill="#FFFFFF" />
          <rect x="10" y="5" width="4" height="2" fill="#FFFFFF" />
          <rect x="8" y="7" width="8" height="2" fill="#312E81" />
          <rect x="6" y="9" width="12" height="2" fill="#1E1B4B" />
          {/* Sakura Blossom Clouds */}
          <rect x="2" y="2" width="7" height="6" fill="#F472B6" />
          <rect x="15" y="2" width="7" height="6" fill="#F472B6" />
          {/* Grand Vermillion Torii Gate */}
          <rect x="4" y="6" width="16" height="2" fill="#18181B" />
          <rect x="5" y="8" width="14" height="2" fill="#DC2626" />
          <rect x="7" y="8" width="2" height="11" fill="#DC2626" />
          <rect x="15" y="8" width="2" height="11" fill="#DC2626" />
          {/* Stone Flagstone Path */}
          <rect x="2" y="17" width="20" height="5" fill="#475569" />
          <rect x="8" y="17" width="8" height="5" fill="#CBD5E1" />
        </svg>
      );
    ...
    case 'rainy_meadow':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Misty Forest Sky & Stepped Pines */}
          <rect x="2" y="2" width="20" height="20" fill="#1E293B" />
          <rect x="4" y="5" width="2" height="2" fill="#047857" />
          <rect x="3" y="7" width="4" height="3" fill="#065F46" />
          <rect x="2" y="10" width="6" height="4" fill="#064E3B" />
          <rect x="18" y="5" width="2" height="2" fill="#047857" />
          <rect x="17" y="7" width="4" height="3" fill="#065F46" />
          <rect x="16" y="10" width="6" height="4" fill="#064E3B" />
          {/* Rain Streaks */}
          <rect x="9" y="4" width="1" height="3" fill="#7DD3FC" />
          <rect x="15" y="6" width="1" height="3" fill="#7DD3FC" />
          {/* Giant Amanita Mushroom on Left */}
          <rect x="3" y="10" width="7" height="4" fill="#DC2626" />
          <rect x="5" y="14" width="3" height="4" fill="#F5F5F4" />
          <rect x="4" y="11" width="1" height="1" fill="#FFFFFF" />
          <rect x="7" y="11" width="1" height="1" fill="#FFFFFF" />
          {/* Mossy River Rock Stage */}
          <rect x="2" y="15" width="20" height="7" fill="#14532D" />
          <rect x="7" y="14" width="10" height="4" fill="#52525B" />
          <rect x="8" y="13" width="8" height="2" fill="#65A30D" />
        </svg>
      );
    ...
    case 'onsen':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Alpine Dusk Sky & Stepped Snow Mountain */}
          <rect x="2" y="2" width="20" height="20" fill="#0F172A" />
          <rect x="11" y="3" width="2" height="2" fill="#FFFFFF" />
          <rect x="9" y="5" width="6" height="2" fill="#FFFFFF" />
          <rect x="7" y="7" width="10" height="3" fill="#1E293B" />
          {/* Bamboo Spout & Wooden Oke Bucket */}
          <rect x="3" y="8" width="4" height="2" fill="#65A30D" />
          <rect x="17" y="8" width="4" height="3" fill="#D97706" />
          <rect x="18" y="7" width="2" height="1" fill="#FFFFFF" />
          {/* Mineral Hot Spring Water & Rising Steam */}
          <rect x="2" y="12" width="20" height="10" fill="#0E7490" />
          <rect x="4" y="14" width="16" height="8" fill="#06B6D4" />
          <rect x="8" y="6" width="2" height="4" fill="#FFFFFF" opacity="0.6" />
          <rect x="14" y="5" width="2" height="4" fill="#FFFFFF" opacity="0.6" />
          {/* Smooth Basalt Stone Dais */}
          <rect x="7" y="14" width="10" height="4" fill="#71717A" />
        </svg>
      );
    ...
    case 'night_camp':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Celestial Night Sky & Crescent Moon */}
          <rect x="2" y="2" width="20" height="20" fill="#020617" />
          <rect x="17" y="4" width="3" height="3" fill="#FEF08A" />
          <rect x="18" y="4" width="2" height="2" fill="#020617" />
          <rect x="6" y="5" width="1" height="1" fill="#FFFFFF" />
          <rect x="11" y="7" width="1" height="1" fill="#FEF08A" />
          {/* Stepped A-Frame Tent on Left */}
          <rect x="5" y="9" width="2" height="2" fill="#0284C7" />
          <rect x="4" y="11" width="4" height="3" fill="#0284C7" />
          <rect x="3" y="14" width="6" height="3" fill="#0284C7" />
          <rect x="2" y="17" width="8" height="2" fill="#0284C7" />
          <rect x="4" y="12" width="4" height="6" fill="#FEF08A" />
          {/* Campfire & Tartan Mat */}
          <rect x="14" y="13" width="5" height="4" fill="#EA580C" />
          <rect x="15" y="12" width="3" height="3" fill="#FACC15" />
          <rect x="14" y="17" width="5" height="1" fill="#78350F" />
          <rect x="2" y="17" width="20" height="5" fill="#0F172A" />
          <rect x="7" y="16" width="10" height="3" fill="#DC2626" />
        </svg>
      );
    ...
    case 'tearoom':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Washi Paper & Shoji Lattice */}
          <rect x="2" y="2" width="20" height="20" fill="#FEF3C7" />
          <rect x="2" y="2" width="20" height="1" fill="#522E11" />
          <rect x="2" y="7" width="20" height="1" fill="#78350F" opacity="0.6" />
          <rect x="8" y="2" width="1" height="12" fill="#78350F" opacity="0.6" />
          <rect x="16" y="2" width="1" height="12" fill="#78350F" opacity="0.6" />
          {/* Hanging Calligraphy Scroll */}
          <rect x="4" y="3" width="3" height="7" fill="#FFFFFF" />
          <rect x="4" y="3" width="3" height="1" fill="#78350F" />
          <rect x="4" y="9" width="3" height="1" fill="#78350F" />
          {/* Bonsai on Right */}
          <rect x="17" y="7" width="4" height="2" fill="#1E293B" />
          <rect x="16" y="4" width="6" height="3" fill="#15803D" />
          {/* Tatami Mats & Lacquer Tea Table with Matcha */}
          <rect x="2" y="14" width="20" height="8" fill="#D9F99D" />
          <rect x="2" y="14" width="20" height="1" fill="#1E293B" />
          <rect x="6" y="15" width="12" height="3" fill="#451A03" />
          <rect x="7" y="14" width="3" height="2" fill="#22C55E" />
        </svg>
      );
    ...
    case 'cloud_palace':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Pastel Dawn Sky */}
          <rect x="2" y="2" width="20" height="20" fill="#6366F1" />
          {/* Golden Stars */}
          <rect x="6" y="5" width="1" height="1" fill="#FEF08A" />
          <rect x="17" y="4" width="2" height="2" fill="#FEF08A" />
          {/* Marble Pillars on Sides */}
          <rect x="3" y="3" width="3" height="13" fill="#FFFFFF" />
          <rect x="2" y="2" width="5" height="2" fill="#FACC15" />
          <rect x="18" y="3" width="3" height="13" fill="#FFFFFF" />
          <rect x="17" y="2" width="5" height="2" fill="#FACC15" />
          {/* Tiered Stepped Fluffy Clouds & Golden Platform */}
          <rect x="2" y="14" width="20" height="8" fill="#DDD6FE" />
          <rect x="4" y="12" width="6" height="4" fill="#FFFFFF" />
          <rect x="9" y="11" width="6" height="5" fill="#FFFFFF" />
          <rect x="14" y="12" width="6" height="4" fill="#FFFFFF" />
          <rect x="7" y="15" width="10" height="3" fill="#FACC15" />
        </svg>
      );
    ...
    case 'bamboo_grove':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          {/* Misty Emerald Atmosphere */}
          <rect x="2" y="2" width="20" height="20" fill="#052E16" />
          {/* Segmented Bamboo Stalks */}
          <rect x="4" y="2" width="3" height="16" fill="#15803D" />
          <rect x="4" y="7" width="3" height="1" fill="#86EFAC" />
          <rect x="4" y="12" width="3" height="1" fill="#86EFAC" />
          <rect x="17" y="2" width="3" height="16" fill="#22C55E" />
          <rect x="17" y="6" width="3" height="1" fill="#86EFAC" />
          <rect x="17" y="11" width="3" height="1" fill="#86EFAC" />
          {/* Red Hanging Paper Lantern */}
          <rect x="9" y="5" width="5" height="6" fill="#DC2626" />
          <rect x="10" y="6" width="3" height="4" fill="#FEF08A" />
          {/* Mossy Stepping Stone Dais */}
          <rect x="2" y="16" width="20" height="6" fill="#14532D" />
          <rect x="7" y="15" width="10" height="3" fill="#94A3B8" />
        </svg>
      );
