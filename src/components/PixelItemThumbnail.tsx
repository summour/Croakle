    ...
    case 'ghost':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          ...
          <rect x="6" y="4" width="12" height="3" fill="#EC4899" />
          <rect x="4" y="7" width="16" height="10" fill="#EC4899" />
          <rect x="5" y="6" width="14" height="10" fill="#F472B6" />
          {/* Ghost Bottom Tentacle Rims */}
          <rect x="4" y="17" width="3" height="3" fill="#EC4899" />
          <rect x="10" y="17" width="4" height="3" fill="#EC4899" />
          <rect x="17" y="17" width="3" height="3" fill="#EC4899" />
          {/* Retro Pixel Eyes */}
          <rect x="6" y="8" width="4" height="5" fill="#FFFFFF" />
          <rect x="8" y="9" width="2" height="3" fill="#1E3A8A" />
          <rect x="14" y="8" width="4" height="5" fill="#FFFFFF" />
          <rect x="16" y="9" width="2" height="3" fill="#1E3A8A" />
        </svg>
      );
    ...
    case 'tamagotchi':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...pixelStyle} className={className}>
          ...
          <rect x="10" y="1" width="4" height="3" fill="#94A3B8" />
          <rect x="11" y="2" width="2" height="1" fill="#F8FAFC" />
          {/* Egg-Shaped Yellow Body */}
          <rect x="6" y="4" width="12" height="17" fill="#CA8A04" />
          <rect x="4" y="6" width="16" height="13" fill="#EAB308" />
          <rect x="5" y="5" width="14" height="15" fill="#FACC15" />
          <rect x="5" y="6" width="2" height="10" fill="#FEF08A" />
          {/* LCD Screen Display */}
          <rect x="7" y="8" width="10" height="7" fill="#65A30D" />
          <rect x="8" y="9" width="8" height="5" fill="#BEF264" />
          {/* Pixel Pet Sprite on LCD */}
          <rect x="10" y="10" width="4" height="3" fill="#14532D" />
          <rect x="11" y="11" width="2" height="1" fill="#BEF264" />
          {/* 3 Physical Buttons */}
          <rect x="7" y="16" width="2" height="2" fill="#EA580C" />
          <rect x="11" y="17" width="2" height="2" fill="#EA580C" />
          <rect x="15" y="16" width="2" height="2" fill="#EA580C" />
        </svg>
      );
