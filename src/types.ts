export type PageType = 'track' | 'project' | 'best' | 'mood' | 'notes' | 'time' | 'analysis' | 'settings';
...
export const MOOD_LEVELS: MoodConfig[] = [
  {
    ...
    label: 'Rad',
    emoji: '✨',
    color: '#FFE500', // Neon Yellow / Gold
    bgLight: 'bg-[#FEF9C3]',
    bgDark: 'dark:bg-[#342A0A]/40',
    borderLight: 'border-[#FACC15]',
    borderDark: 'dark:border-[#EAB308]',
    iconBgLight: 'bg-[#FEF08A]',
    iconBgDark: 'dark:bg-[#4A3B0E]',
    textColorLight: 'text-[#854D0E]',
  ...
  },
  {
    ...
    label: 'Good',
    emoji: '🌸',
    color: '#FF2A85', // Neon Pink / Rose
    bgLight: 'bg-[#FCE7F3]',
    bgDark: 'dark:bg-[#381024]/40',
    borderLight: 'border-[#FF2A85]',
    borderDark: 'dark:border-[#F43F5E]',
    iconBgLight: 'bg-[#FBCFE8]',
    iconBgDark: 'dark:bg-[#5B1444]',
    textColorLight: 'text-[#E11D48]',
    textColorDark: 'dark:text-[#FB7185]',
  },
  {
    value: 3,
    label: 'Meh',
    emoji: '🍀',
    color: '#00E676', // Neon Mint / Emerald
    bgLight: 'bg-[#DCFCE7]',
    bgDark: 'dark:bg-[#0F2E1B]/40',
    borderLight: 'border-[#00E676]',
    borderDark: 'dark:border-[#10B981]',
    iconBgLight: 'bg-[#BBF7D0]',
    iconBgDark: 'dark:bg-[#144626]',
    textColorLight: 'text-[#059669]',
    textColorDark: 'dark:text-[#34D399]',
  },
  {
    value: 2,
    label: 'Bad',
    emoji: '🌊',
    color: '#00E5FF', // Neon Cyan / Electric Blue
    bgLight: 'bg-[#E0F2FE]',
    bgDark: 'dark:bg-[#0C2438]/40',
    borderLight: 'border-[#00E5FF]',
    borderDark: 'dark:border-[#0EA5E9]',
    iconBgLight: 'bg-[#BAE6FD]',
    iconBgDark: 'dark:bg-[#0E3552]',
    textColorLight: 'text-[#0284C7]',
    textColorDark: 'dark:text-[#38BDF8]',
  },
  {
    value: 1,
    label: 'Awful',
    emoji: '💜',
    color: '#B026FF', // Neon Purple / Violet
    bgLight: 'bg-[#F3E8FF]',
    bgDark: 'dark:bg-[#2E1065]/40',
    borderLight: 'border-[#C084FC]',
    borderDark: 'dark:border-[#9333EA]',
    iconBgLight: 'bg-[#E9D5FF]',
    iconBgDark: 'dark:bg-[#4C1D95]',
    textColorLight: 'text-[#7E22CE]',
    textColorDark: 'dark:text-[#C084FC]',
  },
];
